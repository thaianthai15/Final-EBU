        ...
        <div className="flex gap-4 mb-8 overflow-x-auto pb-2 items-center">
            ...
            <div className="flex gap-4">
                <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
                    <img src="https://via.placeholder.com/60" alt="PS5" className="h-16 mb-1"/>
                    <span>PS5</span>
                </div>
                <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
                    <img src="https://via.placeholder.com/60" alt="Xbox" className="h-16 mb-1"/>
                    <span>Xbox</span>
                </div>
                 <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
                    <img src="https://via.placeholder.com/60" alt="Meta Quest" className="h-16 mb-1"/>
                    <span>Meta Quest</span>
                </div>
                <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
                    <img src="https://via.placeholder.com/60" alt="Nintendo Switch" className="h-16 mb-1"/>
