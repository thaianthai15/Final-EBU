        ...
        <div className="flex gap-4 mb-8 overflow-x-auto pb-2 items-center">
          ...
          <div className="flex gap-4">
            <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
              <img src="src/assets/images/smasung_galaxy_mobile.webp" alt="Samsung Galaxy" className="h-16 mb-1" />
              <span>Samsung Galaxy</span>
            </div>
            <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
              <img src="src/assets/images/iphone_mobile-1.webp" alt="iPhone" className="h-16 mb-1" />
              <span>iPhone</span>
            </div>
            <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
              <img src="src/assets/images/iphone_15_desktop-1.webp" alt="iPhone 15" className="h-16 mb-1" />
              <span>iPhone 15</span>
            </div>
            <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
              <img src="src/assets/images/google_pixel_mobile-1.webp" alt="Google Pixel" className="h-16 mb-1" />
              <span>Google Pixel</span>
            </div>
            <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
              <img src="src/assets/images/ipad_desktop.webp" alt="iPad" className="h-16 mb-1" />
              <span>iPad</span>
            </div>
            <div className="flex-shrink-0 w-32 h-28 bg-white border border-gray-200 rounded-lg flex flex-col items-center justify-center p-2 text-center text-sm font-medium shadow-sm hover:shadow-md cursor-pointer">
              <img src="src/assets/images/iphone_16_mobile-1.webp" alt="iPhone 16" className="h-16 mb-1" />
              <span>iPhone 16</span>
            </div>
          </div>
        </div>
