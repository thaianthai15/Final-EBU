...
const faqData = [
  {
    ...
    answer: 'Our Gimo Care policy covers 90% of repair costs for any damages. You only pay 10% of the cost. Normal signs of use are completely free.'
  },
  {
    id: 2,
  ...
  {
    id: 4,
    question: 'Can anyone rent with Gimo?',
    answer: 'Anyone over the age of 18 can rent with Gimo, subject to a standard credit check to ensure a secure experience for everyone.'
  },
];
    ...
    <div className="bg-white font-sans">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-16">
          <div>
            <h1 className="text-5xl font-extrabold text-gray-900 mb-4">Gimo reviews and feedback</h1>
        ...
        <section className="text-center py-16">
          ...
          <img src="src/assets/images/Trustpilot__logo_.png" alt="Trustpilot" className="h-6 mx-auto mt-2" />
        ...
        <section className="bg-gray-50 rounded-lg text-center py-16 my-16">
          <img src="src/assets/images/gimo-logo.png" alt="Gimo App Logo" className="h-16 mx-auto mb-4" />
          <p className="text-sm uppercase font-bold text-gray-500 tracking-wider">GIMO APP</p>
          <h2 className="text-4xl font-extrabold text-gray-900 mt-2">Rated with 4.8/5 stars</h2>
          <p className="text-gray-600 mt-4">Download the app to get the best Gimo experience.</p>
        ...
        <section className="bg-gray-100 rounded-lg p-6 flex items-center justify-between my-16">
          <div className='flex items-center gap-4'>
            ...
            <p className='text-gray-700'>
              <strong>Invite friends, get $50 Gimo Bucks.</strong> Earn $50 to save on tech, and your friend gets their first month free.
            </p>
          </div>
